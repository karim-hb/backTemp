...
namespace Narije.Api.Controllers.Admin
{
    ...
    public class SettlementController : BaseController<Settlement, int, SettlementRequest, SameEntityResponse>
    {
        public SettlementController(IGenericRepository<Settlement, int, SettlementRequest, SameEntityResponse> repository)
            : base(repository)
        {
        }
    }
